...
function MyNFTList({nftList , signerAddress}) {
                      ...
                      nftList.map((nftList, id) => (
                          <div key={id} className=' w-[300px] gap-4 h-[450px] bg-[#1E1F28] rounded-lg justify-center items-center flex flex-col text-white shadow-inner shadow-indigo-500'>
                               <div className=' w-[90%] h-[65%]'>
                                     <img src={nftList.imgUrl} alt="" className='shadow-xl shadow-indigo-500/50 w-[100%] h-[100%] rounded-lg object-cover' />
                               </div>
                               <div className=' w-[90%] flex flex-col gap-2 '>
                                   <span className=' text-xl font-medium'>{nftList.name}</span>
                                   <div className=' flex justify-between w-[100%]'>
                                       {
                                          nftList.rareLevel === "Limited"
                                          && <span className=' p-1 bg-yellow-500 rounded-xl'>{nftList.rareLevel}</span>
                                      }
                                      {
                                          nftList.rareLevel === "Rare"
                                          && <span className=' p-1 bg-violet-700 rounded-xl'>{nftList.rareLevel}</span>
                                      }
                                      {
                                          nftList.rareLevel === "Common"
                                          && <span className=' p-1 bg-gray-500 rounded-xl'>{nftList.rareLevel}</span>
                                      }
                                      {
                                          nftList.rareLevel === ""
                                      ...
                                      {/* <div className=' flex gap-1'>
                                          ...
                                          <span id='' className=' text-lg font-medium'>{nftList.cost} ETH</span>
                                      </div> */}
                                  </div>
                                  <div className=' flex justify-between nftLists-center w-[100%]'>
                                      ...
                                      <button className=' p-3 bg-blue-600 rounded-full'>Sell NFT</button>
                                  </div>
                              </div>
                          </div>
                  )
